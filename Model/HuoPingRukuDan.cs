...
namespace OUDAL
{
    ///################################################################################################
    /// <summary>
    /// <para>摘要：HuoPingRukuDanModel 类，业务模型。</para>
    /// <para>说明：</para>
    /// <para>Programmer： Sean</para>
    /// <para>Email： </para>
    /// <remarks>
    /// 对应数据库表：HuoPingRukuDan
    /// <table class="dtTABLE" cellspacing="0">
    /// <tr valign="top"><th>序号</th><th>列名</th><th>数据类型</th><th>长度</th><th>小数位</th><th>标识</th><th>主键</th><th>允许空</th><th>默认值</th><th>字段说明</th></tr>
    /// <tr valign="top"><td>1</td><td>Id</td><td>int</td><td>4</td><td></td><td>√</td><td>√</td><td></td><td></td><td></td></tr>
    /// <tr valign="top"><td>2</td><td>RuKuDanBianHao</td><td>nvarchar</td><td>50</td><td></td><td></td><td></td><td>√</td><td></td><td>入库单编号</td></tr>
    ...
    /// <tr valign="top"><td>6</td><td>RuKuDanState</td><td>nvarchar</td><td>50</td><td></td><td></td><td></td><td>√</td><td></td><td>入库单状态（代确认；已确认；已作废）</td></tr>
    /// <tr valign="top"><td>7</td><td>RuKuDate</td><td>datetime</td><td>8</td><td></td><td></td><td></td><td>√</td><td></td><td>入库日期</td></tr>
    ...
    /// <tr valign="top"><td>10</td><td>RuKuDanLeiXing</td><td>int</td><td>4</td><td></td><td></td><td></td><td>√</td><td></td><td>1:行政易耗品；2：门店</td></tr>
    /// <tr valign="top"><td>11</td><td>CaiGouDanId</td><td>int</td><td>4</td><td></td><td></td><td></td><td>√</td><td></td><td>入库单ID</td></tr>
    /// </table>
    /// </remarks>
    /// </summary>
    ///################################################################################################
    [Table("HuoPingRukuDan")]
    [Serializable]
    public partial class HuoPingRukuDan
    {

        public static string LogClass = "HuoPingRukuDan";
        #region -  公共属性  ------------------------------------------------------------
        ...
        /// 入库单状态（代确认；已确认；已作废）
        /// </summary>
        private string _RuKuDanState = "";
        /// <summary>
        /// 入库单状态（代确认；已确认；已作废）
        /// </summary>
        [DisplayName("入库单状态")]

        public string RuKuDanState
        {
            set { _RuKuDanState = value; }
            get { return _RuKuDanState; }
        }
        ...
        /// 1:行政易耗品；2：门店
        /// </summary>
        private int? _RuKuDanLeiXing;
        /// <summary>
        /// 1:行政易耗品；2：门店
        /// </summary>
        [DisplayName("1:行政易耗品；2：门店")]

        public int? RuKuDanLeiXing
        {
            set { _RuKuDanLeiXing = value; }
            get { return _RuKuDanLeiXing; }
        }
    ...
    public partial class HuoPingRukuDanReq : BaseSearchReq
    {
        #region -  公共属性  ------------------------------------------------------------
        ...
        /// 入库单状态（代确认；已确认；已作废）
        /// </summary> 
        public string RuKuDanState { get; set; }
        ...
        /// 1:行政易耗品；2：门店
        /// </summary> 
        public int? RuKuDanLeiXing { get; set; }
